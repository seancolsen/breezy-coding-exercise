...
- ✅ Integrate with at least one real music-related external API or service. Examples: Spotify Web API, iTunes Search API, Deezer API, Last.fm, or a similar service.
- ✅ Generate a playlist of 8-15 songs
- ✅ Generate a playlist title
- ✅ Generate a short explanation of why the result fits the request.
- ✅ Support at least one human-in-the-loop editing action, such as removing a song, pinning a song, or changing the prompt and regenerating.
...
- A short README that covers: what you built; what you prioritized; what you would do next with more time; which external integration you chose and why; the 2-3 most useful prompts you gave your AI tool; and one example of AI output you rejected or corrected.

- A screen recording of your 90-minute session showing your workflow with AI tools.

## What we will evaluate

- AI tool fluency: How effectively you use AI tools to scope, scaffold, debug, iterate, and correct bad output.

- Integration judgment: How quickly you navigate external docs, normalize external data, and avoid integration dead ends.

- Product and UX thinking: Whether the result feels usable and whether the user has a sensible refine/edit loop.
...
- Add a 'more like this' or 'less like this' refinement loop
...
This exercise is intentionally open-ended. There is no single right architecture. What matters most is your judgment: what you choose to build, how you use AI tools, and how coherent the finished result feels after 90 minutes.
